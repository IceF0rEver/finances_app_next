	...
	return (
		<section className="flex h-screen justify-center items-center">
			<Card className="w-full max-w-md">
				<CardHeader>
					<CardTitle>{t('app.auth.forgetPassword.page.title')}</CardTitle>
					<CardDescription>{t('app.auth.forgetPassword.page.description')}</CardDescription>
				</CardHeader>
				<CardContent className="grid gap-4">
					...
					<div className="grid gap-2">
						<Label htmlFor="email">{t('app.auth.forgetPassword.page.form.email.label')}</Label>
						<Input
							id="email"
							type="email"
					...
					>
						{loading ? (
							...
							<p> {t('app.auth.forgetPassword.page.button.submit')} </p>
						)}
					</Button>
				</CardContent>
				<CardFooter>
					<div className="flex justify-center w-full border-t py-4">
						...
						<Link
							...
							className="underline"
						>
							<span>{t('app.auth.forgetPassword.page.link.login')}</span>
						</Link>
						</p>
					</div>
				</CardFooter>
