...
import ThemeColor from "@/components/utils/theme-color";
...
export default function Appearance() {
	...
	const items = useMemo(
		() => [
			...
			{
				label: t("components.settings.form.themeColor.label"),
				description: t("components.settings.form.themeColor.description"),
